...
public class CircuitBoardPropertiesEditWizard extends AppFXMLComponent implements Initializable {
	...
	public static void createNewGate(String name) {
		...
		dialog.setScene(new Scene((Parent) new CircuitBoardPropertiesEditWizard(dialog, name).loadAsNode(), 650, 700));
	...
	private static void openCircuitBoardPropertiesEditableView(String name, boolean editAsNewModel) { 
		...
		Stage dialog = new Stage();
		dialog.setScene(new Scene((Parent) new CircuitBoardPropertiesEditWizard(dialog, gm, editAsNewModel).loadAsNode(), 650, 700));
		dialog.initOwner(primary);
		dialog.initModality(Modality.APPLICATION_MODAL);
	...
	public CircuitBoardPropertiesEditWizard(Stage stage, String name) {
	...
	public CircuitBoardPropertiesEditWizard(Stage stage, CircuitBoardModel cb, boolean editAsNew) {
		super("CircuitBoardProperties.fxml");
		this.stage = stage;
		this.cb = cb;
